...
export const toggleEmployeeStatusApi = (id, status) =>
...
export const getEmployeeVehicleSpecializationsApi = () =>
  api.get('/employees/vehicle-specializations');

export const createEmployeeVehicleSpecializationApi = (name) =>
  api.post('/employees/vehicle-specializations', { name });