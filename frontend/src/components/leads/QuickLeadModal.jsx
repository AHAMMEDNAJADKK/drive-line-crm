          ...
          <div className="rounded-xl border border-amber-200 dark:border-amber-800/50 bg-amber-50 dark:bg-amber-900/20 p-4 space-y-3">
            <div className="flex items-start gap-2">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-amber-800/90 dark:text-amber-300/90 mt-1 space-y-0.5">
                  <p><span className="font-semibold text-gray-900 dark:text-gray-100">{existing.customerName || 'Customer'}</span> ({existing.mobileNumber})</p>
                  {(existing.partRequired || existing.vehicleModel) && (
                    <p className="text-[11px] text-gray-700 dark:text-gray-300">{[existing.vehicleModel, existing.partRequired].filter(Boolean).join(' • ')}</p>
                  )}
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-amber-600 text-xs font-semibold text-white hover:bg-amber-500 transition-colors shadow-sm"
              >
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-xs font-semibold text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
              >
