...
import { Car, Eye, EyeOff, Loader2, ShieldCheck, UserCheck, Briefcase } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center p-4 transition-colors duration-200">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Drive Line</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Automobile Parts CRM</p>
        </div>

        {/* Form card */}
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/50 p-6 sm:p-8">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-5">Sign in to your account</h2>
          ...
          <div className="mt-6 pt-5 border-t border-gray-100 dark:border-gray-700/50">
            ...
            <div className="grid grid-cols-3 gap-2">
              <button
                type="button"
                onClick={() => fillCredentials('admin@driveline.com', 'Admin@123')}
              ...
              <button
                type="button"
                onClick={() => fillCredentials('manager@driveline.com', 'Manager@123')}
              ...
              <button
                type="button"
                onClick={() => fillCredentials('rahul@driveline.com', 'Employee@123')}
