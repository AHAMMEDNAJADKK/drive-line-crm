...
const supplierSchema = new mongoose.Schema(
  {
    ...
    shopWarehouseName: { type: String, trim: true, default: '' },
    trnNumber: { type: String, trim: true, default: '' },
    country: { type: String, trim: true, default: '' },
    city: { type: String, trim: true, default: '' },
    address: { type: String, trim: true, default: '' },
    supplierType: { type: String, enum: SUPPLIER_TYPES, default: 'Other' },
...
supplierSchema.pre('save', function (next) {
  if (this.isModified('phone') && this.phone) this.phone = normalizePhoneNumber(this.phone);
